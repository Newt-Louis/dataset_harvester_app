...
.hint-text { color: var(--p-text-color-secondary); font-size: 0.85rem; font-style: italic; margin-bottom: 1rem; margin-top: -1rem; }
...
:deep(.fixed-width-input) { width: 6rem !important; text-align: center; }

.action-bar { margin-top: 2rem; }
.forecast-msg { border-left: 4px solid var(--p-primary-color); margin-bottom: 16px; }
.forecast-content { font-size: 0.95rem; line-height: 1.5; }
.highlight-total { font-size: 1.1rem; font-weight: bold; color: var(--p-primary-color); }
.run-btn { height: 3.5rem; font-size: 1.2rem; font-weight: bold; letter-spacing: 1px; }

@media (max-width: 768px) {
  .schema-header { flex-direction: column; align-items: flex-start; gap: 0.5rem; }
